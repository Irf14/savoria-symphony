...
const cuisines = {
  thai: {
    ...
    intro:
      'Experience the vibrant flavors of Thailand with our authentic dishes crafted with traditional herbs and spices.',
    color: 'theme-thai',
    gradient: 'bg-thai-gradient',
    categoryBackgrounds: {
      appetizers:
        'https://images.unsplash.com/photo-1562565652-a0d8f0c59eb4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80',
      mainCourse:
        'https://images.unsplash.com/photo-1562167125-ce4c0ec88433?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2074&q=80',
      desserts:
        'https://images.unsplash.com/photo-1561295089-95d8eb3503fb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80'
    }
  },
  chinese: {
    name: 'Chinese',
    background:
      'https://images.unsplash.com/photo-1563245372-f21724e3856d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
    intro:
      'Discover the rich culinary heritage of China through our carefully selected dishes representing various regions.',
    color: 'theme-chinese',
    gradient: 'bg-chinese-gradient',
    categoryBackgrounds: {
      appetizers:
        'https://images.unsplash.com/photo-1541529086526-db283c563270?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
      mainCourse:
        'https://images.unsplash.com/photo-1572802419224-296b0aeee0d9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2115&q=80',
      desserts:
        'https://images.unsplash.com/photo-1563805042-7684c019e1cb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2327&q=80'
    }
  },
  indian: {
    name: 'Indian',
    ...
    intro:
      'Indulge in the aromatic spices and complex flavors of India with our authentic recipes passed down through generations.',
    color: 'theme-indian',
    gradient: 'bg-indian-gradient',
    categoryBackgrounds: {
      appetizers:
        'https://images.unsplash.com/photo-1565557623262-b51c2513a641?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80',
      mainCourse:
        'https://images.unsplash.com/photo-1585937421612-70a008356fbe?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2036&q=80',
      desserts:
        'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80'
    }
  },
  bengali: {
    name: 'Bengali',
    ...
    intro:
      'Sample the subtle yet distinctive flavors of Bengal, where seafood, rice, and mustard come together in perfect harmony.',
    color: 'theme-bengali',
    ...
    categoryBackgrounds: {
      ...
      mainCourse:
        'https://images.unsplash.com/photo-1589538539809-8531b89c6b78?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2532&q=80',
      desserts:
        'https://images.unsplash.com/photo-1589227365533-c092a871e862?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80'
    }
  },
  continental: {
    name: 'Continental',
    ...
    intro:
      'Enjoy the refined flavors of Europe with our selection of classic Continental dishes prepared with a modern twist.',
    color: 'theme-continental',
    gradient: 'bg-continental-gradient',
    categoryBackgrounds: {
      appetizers:
        'https://images.unsplash.com/photo-1626200419199-391ae4be7a9c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
      mainCourse:
...
const MenuPage = () => {
  ...
  const renderMenuItem = (item: any) => (
    ...
    >
      <div className="flex flex-col md:flex-row md:items-center justify-between">
            ...
            <div className="flex items-center mr-4">
              {[1, 2, 3, 4, 5].map((star) => (
                <Star
                  ...
                  size={16}
                  className={`${
                    star <= Math.floor(item.rating) ? 'text-gold' : 'text-gray-500'
                  } ${
        ...
        <div className="font-playfair text-2xl text-gold mt-4 md:mt-0">${item.price}</div>
      </div>
    </motion.div>
  );
  ...
  return (
    <div className={`min-h-screen ${currentCuisine.color}`}>
      ...
      {/* Loader if background is not loaded */}
      {!backgroundLoaded && !loaded && (
        ...
        <main className="container mx-auto px-4 py-24">
          ...
          <div className="max-w-4xl mx-auto">
            <AnimatePresence mode="wait">
              ...
              >
                {loaded ? (
                  menuItems[activeCategory].map((item: any) => renderMenuItem(item))
                ) : (
